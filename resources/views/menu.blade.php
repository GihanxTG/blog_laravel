                ...
                <div class="container px-0">
                    <div class="topbar-top d-flex justify-content-between flex-lg-wrap">
                        ...
                        <div class="top-link flex-lg-wrap">
                            <i class="fas fa-calendar-alt text-white border-end border-secondary pe-2 me-2"> <span class="text-body"><?= date('l d/m/', time()+3600*7) . '' . date('Y'); ?></span></i>
                                ...
                                <div class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu m-0 bg-secondary rounded-0" style="width: 300px;">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <a href="{{ url('/loaitin', [$theloai->id]) }}" class="dropdown-item">{{$theloai->ten}}</a>
                                            </div>
                                            @endforeach
                                            <!-- <div class="col-6">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex flex-column ms-2" style="width: 150px;">
                                            ...
                                            <small><?= date('d/m/', time()+3600*7) . '' . date('Y'); ?></small>
                                        </div>
                                    </div>
                                </div>
