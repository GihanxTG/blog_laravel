                ...
                <div class="row g-4">
                    <div class="col-lg-7 col-xl-8 mt-0">
                        ...
                        <div class="border-bottom py-3">
                            <a href="{{ url('/detail', [$tinnoibat->id]) }}" class="display-4 text-dark mb-0 link-hover">{{$tinnoibat->tieuDe}}</a>
                        </div>
                                    ...
                                    <div class="row g-4 align-items-center">
                                        ...
                                        <div class="col-7">
                                            <div class="features-content d-flex flex-column">
                                                <a href="{{ url('/detail', [$xemnhieu->id]) }}" class="h6">{{$xemnhieu->tieuDe}}</a>
                    ...
                    <div class="latest-news-item">
                        <div class="bg-light rounded">
                            ...
                            <div class="d-flex flex-column p-4">
                                <a href="{{ url('/detail', [$tinmoi->id]) }}" class="h4 td-2line">{{$tinmoi->tieuDe}}</a>
